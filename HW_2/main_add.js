...
const fuelTankVolume = parseFloat(prompt('Введите объем топливного бака в литрах: '));
const distanceAC = parseFloat(prompt('Введите расстояние из пункта А в пункт С, км: '));
